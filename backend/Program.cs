...
using (var scope = app.Services.CreateScope())
{
    ...
    if (db.Database.IsNpgsql())
    {
        ...
        CREATE INDEX IF NOT EXISTS ""IX_MediaIdentities_MediaFileId"" ON ""MediaIdentities"" (""MediaFileId"");
        ...
        CREATE INDEX IF NOT EXISTS ""IX_MediaTags_MediaFileId_Namespace_Key"" ON ""MediaTags"" (""MediaFileId"", ""Namespace"", ""Key"");
